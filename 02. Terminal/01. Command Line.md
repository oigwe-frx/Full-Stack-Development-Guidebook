...
| ls  -t | list via time | lists all contents within the directory, by the time they were last modified. | Output: ``` total 0
drwxr-xr-x 4 ccuser ccuser 172 Dec 19  2022 action drwxr-xr-x 4 ccuser ccuser  77 Nov 28  2022 comedy -rw------- 1 ccuser ccuser   0 Apr 25  2022 genres.txt```|
